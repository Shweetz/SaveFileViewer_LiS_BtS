...
namespace savefiledecoder
{
    ...
    class Checkpoint
    {
        ...
        public string PointIdentifier
        {
            get
            {
                return m_CheckPoint != null ? m_CheckPoint.pointIdentifier : "a";
            }
        ...
        public string Objective
        {
            get
            {
                return m_CheckPoint != null ? m_CheckPoint.currentObjective : "b";
            }
        }
    ...
    class GameSave
    {
        ...
        public void Read(string path)
        {
            ...
            m_Data = Newtonsoft.Json.JsonConvert.DeserializeObject(Raw); 
